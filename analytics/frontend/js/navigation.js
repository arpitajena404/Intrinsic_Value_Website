      ...
      blurred.forEach(function (el) {
        ...
        if (container) {
          ...
          if (!container.querySelector(".iv-lock-overlay")) {
            ...
            overlay.href = "https://premium.intrinsicvalueequity.in/checkout/38ec7375-07c1-481b-b248-76d1626ae50e";
          ...
          if (!el.classList.contains("iv-clickable-blur")) {
            ...
            el.addEventListener("click", function (e) {
              e.stopPropagation();
              window.location.href = "https://premium.intrinsicvalueequity.in/checkout/38ec7375-07c1-481b-b248-76d1626ae50e";
            });
          }
        }
      });
